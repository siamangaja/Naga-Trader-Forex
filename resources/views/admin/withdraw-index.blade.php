                ...
                <table id="kt_profile_overview_table" class="table table-row-bordered table-row-dashed gy-4 align-middle fw-bolder">
                    ...
                    <tbody class="fs-6">
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($d->status == 0)
                                <a href="admin/withdraw/confirm/{{$d->ref}}" onclick="return confirm('Yakin validasi data ini?')" class="btn btn-success btn-sm"><i class="fa fa-check"></i> Validasi</a>
                                @endif
                                <a href="admin/withdraw/delete/{{$d->ref}}" onclick="return confirm('Yakin untuk menghapus data ini?')" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Hapus</a>
                            </td>
                        </tr>
                        @empty
                        <tr>
